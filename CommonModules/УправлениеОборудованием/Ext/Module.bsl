...
//////////////////////////////////////////////////		
	...
	//ФотоСкамеры = Новый ОбрабатываемаяКартинка(Новый Картинка(ДвоичныеДанныеФотографии));
	//ФотоСкамеры.УстановитьРазмер(640, 480);
	//ДвоичныеДанныеФотографии = ФотоСкамеры.ПолучитьКартинку().ПолучитьДвоичныеДанные();
