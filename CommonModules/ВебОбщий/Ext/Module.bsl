...
Процедура ИзменитьПриоритетПрокси(ПроксиСервер, Дельта) Экспорт
	...
	Попытка
	    ...
	    ЭлементБлокировки = Блокировка.Добавить("Справочник.ПроксиСервера");
	    ЭлементБлокировки.УстановитьЗначение("Ссылка", ПроксиСервер);
	    ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;  
	    Блокировка.Заблокировать();
		
		ОбъектПроксиСервер = ПроксиСервер.ПолучитьОбъект();
		ТекущийПриоритетПрокси = ОбъектПроксиСервер.ПриоритетИспользования;
