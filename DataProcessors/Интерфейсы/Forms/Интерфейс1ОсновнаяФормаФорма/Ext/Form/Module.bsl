...
&НаКлиенте
Процедура Телеграм_СообщенияОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	ОткрытьФОрму("Документ.ТелеграмСообщенияВходящие.ФормаСписка");
КонецПроцедуры
